...
drn_arr_Escape_StartPositionGuardTypes = ["Ins_Soldier_AR", "Ins_Soldier_GL", "Ins_Soldier_1", "Ins_Soldier_2", "Ins_Soldier_Sab", "Ins_Soldier_Sapper", "Ins_Woodlander2", "Ins_Woodlander3"];
...
drn_arr_Escape_MilitaryTraffic_CivilianVehicleClasses = ["SkodaBlue", "SkodaGreen", "SkodaRed", "Skoda", "VWGolf", "TT650_Civ", "MMT_Civ", "hilux1_civil_2_covered", "hilux1_civil_1_open", "hilux1_civil_3_open", "car_hatchback", "datsun1_civil_1_open", "datsun1_civil_2_covered", "datsun1_civil_3_open", "V3S_Civ", "car_sedan", "Tractor", "UralCivil", "UralCivil2", "Lada_base", "LadaLM", "Lada2", "Lada1", "Lada1_TK_CIV_EP1", "Lada2_TK_CIV_EP1", "Kamaz", "KamazOpen", "S1203_TK_CIV_EP1", "Old_moto_TK_Civ_EP1", "Old_bike_TK_CIV_EP1", "TT650_TK_CIV_EP1", "VolhaLimo_TK_CIV_EP1", "Volha_1_TK_CIV_EP1", "Volha_2_TK_CIV_EP1", "V3S_Refuel_TK_GUE_EP1", "V3S_Open_TK_CIV_EP1", "SUV_TK_CIV_EP1"];

// Random arrays. Enemy vehicle classes for ambient traffic. (Can also be set to a faction name).
// Variable _enemyFrequency applies to server parameter, and can be one of the values 1 (Few), 2 (Some) or 3 (A lot).
switch (_enemyFrequency) do {
    case 1: {
        drn_arr_Escape_MilitaryTraffic_EnemyVehicleClasses = ["TT650_Ins", "Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_INS", "UAZ_AGS30_INS", "UAZ_MG_INS", "UAZ_SPG9_INS", "Ural_INS", "UralOpen_INS", "Ural_ZU23_INS", "BMP2_Ambul_INS", "UralRefuel_INS", "BMP2_INS", "BMP2_HQ_INS", "BRDM2_INS", "BRDM2_ATGM_INS", "T72_INS", "ZSU_INS", "TT650_Ins", "Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_INS", "UAZ_AGS30_INS", "UAZ_MG_INS", "UAZ_SPG9_INS", "Ural_INS", "UralOpen_INS", "Ural_ZU23_INS", "BMP2_Ambul_INS", "UralRefuel_INS", "TT650_Ins", "Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_INS", "UAZ_AGS30_INS", "UAZ_MG_INS", "UAZ_SPG9_INS", "Ural_INS", "UralOpen_INS", "Ural_ZU23_INS", "BMP2_Ambul_INS", "UralRefuel_INS", "TT650_Ins", "Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_INS", "UAZ_AGS30_INS", "UAZ_MG_INS", "UAZ_SPG9_INS", "Ural_INS", "UralOpen_INS", "Ural_ZU23_INS", "BMP2_Ambul_INS", "UralRefuel_INS", "TT650_Ins", "Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_INS", "UAZ_AGS30_INS", "UAZ_MG_INS", "UAZ_SPG9_INS", "Ural_INS", "UralOpen_INS", "Ural_ZU23_INS", "BMP2_Ambul_INS", "UralRefuel_INS", "GRAD_INS", "UralRepair_INS", "UralRepair_INS", "Kamaz", "KamazOpen", "V3S_Refuel_TK_GUE_EP1", "Ural_ZU23_INS", "ATV_US_EP1", "GRAD_INS", "BMP3", "KamazRepair", "KamazReammo", "GAZ_Vodnik_HMG"];
    };
    case 2: {
        drn_arr_Escape_MilitaryTraffic_EnemyVehicleClasses = ["TT650_Ins", "Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_INS", "UAZ_AGS30_INS", "UAZ_MG_INS", "UAZ_SPG9_INS", "Ural_INS", "UralOpen_INS", "Ural_ZU23_INS", "BMP2_Ambul_INS", "UralRefuel_INS", "BMP2_INS", "BMP2_HQ_INS", "BRDM2_INS", "BRDM2_ATGM_INS", "T72_INS", "ZSU_INS", "TT650_Ins", "Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_INS", "UAZ_AGS30_INS", "UAZ_MG_INS", "UAZ_SPG9_INS", "Ural_INS", "UralOpen_INS", "Ural_ZU23_INS", "BMP2_Ambul_INS", "UralRefuel_INS", "TT650_Ins", "Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_INS", "UAZ_AGS30_INS", "UAZ_MG_INS", "UAZ_SPG9_INS", "Ural_INS", "UralOpen_INS", "Ural_ZU23_INS", "BMP2_Ambul_INS", "UralRefuel_INS", "GRAD_INS", "UralRepair_INS", "UralRepair_INS", "Kamaz", "KamazOpen", "V3S_Refuel_TK_GUE_EP1", "Ural_ZU23_INS", "ATV_US_EP1", "GRAD_INS", "BMP3", "KamazRepair", "KamazReammo", "GAZ_Vodnik_HMG"];
    };
...
drn_arr_Escape_InfantryTypes = ["Ins_Soldier_AA", "Ins_Soldier_AT", "Ins_Soldier_AT", "Ins_Soldier_AR", "Ins_Soldier_GL", "Ins_Soldier_MG", "Ins_Soldier_Medic", "Ins_Soldier_1", "Ins_Soldier_2", "Ins_Soldier_Sniper", "Ins_Soldier_AR", "Ins_Soldier_GL", "Ins_Soldier_MG", "Ins_Soldier_Medic", "Ins_Soldier_1", "Ins_Soldier_2", "Ins_Soldier_Sniper", "Ins_Soldier_AR", "Ins_Soldier_GL", "Ins_Soldier_MG", "Ins_Soldier_Medic", "Ins_Soldier_1", "Ins_Soldier_2", "Ins_Soldier_Sniper", "Ins_Soldier_AR", "Ins_Soldier_GL", "Ins_Soldier_MG", "Ins_Soldier_Medic", "Ins_Soldier_1", "Ins_Soldier_2", "Ins_Soldier_Sniper", "Ins_Soldier_AR", "Ins_Soldier_GL", "Ins_Soldier_MG", "Ins_Soldier_Medic", "Ins_Soldier_1", "Ins_Soldier_2", "Ins_Soldier_Sniper", "Ins_Soldier_Crew", "Ins_Soldier_Sab", "Ins_Woodlander1", "Ins_Woodlander2", "Ins_Woodlander3", "INS_Villager3", "INS_Villager4", "Ins_Soldier_CO", "Ins_Soldier_AA", "Ins_Soldier_AT", "Ins_Soldier_AT", "Ins_Soldier_AR", "Ins_Soldier_GL", "Ins_Soldier_MG", "Ins_Soldier_Medic", "Ins_Soldier_1", "Ins_Soldier_2", "Ins_Soldier_Sniper", "Ins_Soldier_AR", "Ins_Soldier_GL", "Ins_Soldier_MG", "Ins_Soldier_Medic", "Ins_Soldier_1", "Ins_Soldier_2", "Ins_Soldier_Sniper", "Ins_Soldier_AR", "Ins_Soldier_GL", "Ins_Soldier_MG", "Ins_Soldier_Medic", "Ins_Soldier_1", "Ins_Soldier_2", "Ins_Soldier_Sniper", "Ins_Soldier_AR", "Ins_Soldier_GL", "Ins_Soldier_MG", "Ins_Soldier_Medic", "Ins_Soldier_1", "Ins_Soldier_2", "Ins_Soldier_Sniper", "Ins_Soldier_AR", "Ins_Soldier_GL", "Ins_Soldier_MG", "Ins_Soldier_Medic", "Ins_Soldier_1", "Ins_Soldier_2", "Ins_Soldier_Sniper", "Ins_Soldier_Crew", "Ins_Soldier_Sab", "Ins_Woodlander1", "Ins_Woodlander2", "Ins_Woodlander3", "Ins_Soldier_CO", "RUS_Commander", "RU_Soldier_Sniper", "RU_Soldier_Spotter", "RUS_Soldier1", "RUS_Soldier2", "RUS_Soldier3", "RUS_Soldier_GL", "RUS_Soldier_Marksman", "RUS_Soldier_TL", "MVD_Soldier", "MVD_Soldier_AT", "MVD_Soldier_GL", "MVD_Soldier_MG", "MVD_Soldier_Marksman", "MVD_Soldier_Sniper", "MVD_Soldier_TL"];

// Random array. A roadblock has a manned vehicle. This array contains possible manned vehicles (can be of any kind, like cars, armored and statics).
drn_arr_Escape_RoadBlock_MannedVehicleTypes = ["Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_INS", "UAZ_AGS30_INS", "UAZ_MG_INS", "UAZ_SPG9_INS", "BMP2_INS", "BMP2_HQ_INS", "BRDM2_INS", "BRDM2_ATGM_INS", "T72_INS", "ZSU_INS", "AGS_Ins", "DSHKM_Ins", "DSHkM_Mini_TriPod", "SPG9_Ins", "Ural_ZU23_INS", "GAZ_Vodnik_HMG", "ZSU_INS"];

// Random array. Vehicle classes (preferrably trucks) transporting enemy reinforcements.
drn_arr_Escape_ReinforcementTruck_vehicleClasses = ["Ural_INS", "UralOpen_INS", "Kamaz", "KamazOpen"];
...
drn_arr_Escape_MotorizedSearchGroup_vehicleClasses = ["BMP2_INS", "BMP3", "BTR90", "GAZ_Vodnik", "GAZ_Vodnik_HMG", "BRDM2_INS", "BRDM2_ATGM_INS"];
...
drn_arr_ComCenDefence_lightArmorClasses = ["BMP2_INS", "BRDM2_INS", "BMP3", "BTR90", "GAZ_Vodnik", "BRDM2_INS", "BRDM2_ATGM_INS"];
// Random array. Heavy armored vehicles guarding the communication centers.
drn_arr_ComCenDefence_heavyArmorClasses = ["T72_INS", "ZSU_INS", "2S6M_Tunguska", "T90"];

// A communication center contains two static weapons (in two corners of the communication center).
// Random array. Possible static weapon types for communication centers.
drn_arr_ComCenStaticWeapons = ["DSHKM_Ins", "2b14_82mm_INS", "SearchLight_INS", "ZU23_Ins", "D30_Ins", "AGS_Ins", "SPG9_Ins"];
// A communication center have two parked and empty vehicles of the following possible types.
drn_arr_ComCenParkedVehicles = ["TT650_Ins", "Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_INS", "UAZ_INS", "UAZ_INS", "UAZ_INS", "UAZ_INS", "UAZ_INS", "UAZ_AGS30_INS", "UAZ_MG_INS", "UAZ_SPG9_INS", "GRAD_INS", "UralRepair_INS"];
...
drn_arr_Escape_AmmoDepot_StaticWeaponClasses = ["DSHkM_Mini_TriPod", "AGS_Ins", "DSHKM_Ins", "DSHKM_Ins", "SearchLight_INS", "2b14_82mm_INS", "D30_Ins", "ZU23_Ins", "SPG9_Ins"];
// An ammo depot have one parked and empty vehicle of the following possible types.
drn_arr_Escape_AmmoDepot_ParkedVehicleClasses = ["Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_INS", "UAZ_AGS30_INS", "UAZ_MG_INS", "UAZ_SPG9_INS", "Ural_INS", "UralOpen_INS", "GRAD_INS", "UralRepair_INS", "Kamaz", "KamazOpen", "BRDM2_ATGM_INS", "BRDM2_INS", "GAZ_Vodnik_MedEvac"];
