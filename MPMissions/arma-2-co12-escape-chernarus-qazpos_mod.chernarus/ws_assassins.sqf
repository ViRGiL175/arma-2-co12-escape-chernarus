...
_weaponarr = ["I44_M37Ithaca", "I44_K98k", "I44_P38", "I44_WebleyMk6", "I44_MP40"]; //Modify this array for the randomized weapon selection.
//ARMA 3: _weaponarr = ["hgun_Rook40_F","hgun_P07_F"];  	  //An example array containing the two ARMA 3 Alpha handguns
_flee = 0.5; 						//can be any value between 0 and 1. if 1 the sleepers flee as long as they are disguised, if 0 they are less prone to (but still might)
